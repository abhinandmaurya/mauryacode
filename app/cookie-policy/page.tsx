  ...
  return (
    <div className="container py-32 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <p>
          This Cookie Policy explains how TechAgency ("we," "our," or "us") uses cookies and similar technologies to
        ...
        <p>
          Cookies set by the website owner (in this case, TechAgency) are called "first-party cookies." Cookies set by
        ...
        <ul>
          ...
          <li>
            <strong>Social Media Cookies:</strong> These cookies are used to enable you to share pages and content that
        ...
        <ul>
          <li>By email: privacy@techagency.com</li>
          <li>By phone: +1 (555) 123-4567</li>
          <li>By mail: 123 Tech Street, Suite 456, San Francisco, CA 94105, United States</li>
        </ul>
      </div>
    </div>
  )
